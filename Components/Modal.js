            ...
            <div className='bg-black w-[350px] md:w-[650px] text-white absolute left-[50%] translate-x-[-50%] mt-[40px] p-4 rounded-[20px]'
                ...
                <div className='relative mt-8 grid grid-cols-[48px,1fr] gap-4'>
                    ...
                    <div>
                        ...
                        <p className='mt-4 text-gray-500'>Replying to: <span className='text-[#FFD700]'>@{post?.tag}</span></p>
                    ...
                    <div className='mt-4'>
                        <textarea
                            ...
                            rows="4"
                            placeholder="Drag your reply"
                            value={input}
                            onChange={(e) => setInput(e.target.value)} />

                        <div className='flex justify-between items-center'>
                            <div className='flex gap-4 text-[20px] text-[#6e767d] '>

                                <BsImage  className="hover:text-[#FFD700]" />

                                <div className='border-[#6e767d] hover:border-[#FFD700] hover:text-[#FFD700] border rounded h-[18px] text-[16px] grid place-items-center'>
                                    <AiOutlineGif />
                                </div>
                                <RiBarChart2Line className='rotate-90 hover:text-[#FFD700]' />
                                <BsEmojiSmile className="hover:text-[#FFD700]" />
                                <IoCalendarNumberOutline className='hidden md:block hover:text-[#FFD700]' />
                                <HiOutlineLocationMarker className='hidden md:block hover:text-[#FFD700]' />
                            </div>

                            <button
                                className=" rounded-full px-4 py-1.5 font-bold shadow-md
                                bg-[#FFD700]  disabled:hover:bg-yellow-500 disabled:opacity-50
